...
<head>
    ...
    <link href="../../admin/css/font-awesome.min.css" rel="stylesheet"
          type="text/css">
    <link href="../../admin/css/boot-crm.css" rel="stylesheet"
          type="text/css">
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation"
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">网上花店管理系统 v2.0</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <ul class="nav navbar-top-links navbar-right">
            <li class="dropdown"><a class="dropdown-toggle"
                ...
                <ul class="dropdown-menu dropdown-messages">
                    <li><a href="#">
                        <div>
                            <strong>${userName}</strong> <span class="pull-right text-muted">
									<em>昨天</em>
								</span>
                        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline" action=""
                    ...
                    <div class="form-group">
                        <label for="customerFrom">客户电话</label>
                        <input class="form-control" id="customerFrom" placeholder="客户电话" name="custSource"/>
                    </div>
                    <div class="form-group">
                        <label for="custIndustry">订单编号</label>
                        <input class="form-control" id="custIndustry" name="custIndustry" placeholder="订单编号"/>
                    </div>
                    ...
                    <div class="col-md-12 text-right">
                        <div class="page-bar">
                            <ul class="page-num-ul clearfix">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/users/usersList.action?page=${1}">首页</a>
                                <a href="${pageContext.request.contextPath}/admin/users/usersList.action?page=${requestScope.curPage<=1?1:requestScope.curPage-1}">上一页</a>
                                <a href="${pageContext.request.contextPath}/admin/users/usersList.action?page=${requestScope.curPage>=requestScope.param?requestScope.param:requestScope.curPage+1}">下一页</a>
                                <a href="${pageContext.request.contextPath}/admin/users/usersList.action?page=${requestScope.param}">最后一页</a>
                            </ul>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="edit_customer_form">
                    ...
                    <div class="form-group">
                        <label for="edit_custIndustry" style="float:left;padding:7px 15px 0 27px;">客户密码</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="password" id="edit_custIndustry" name="cust_industry"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="edit_phone" class="col-sm-2 control-label">客户生日</label>
                        <div class="col-sm-10">
