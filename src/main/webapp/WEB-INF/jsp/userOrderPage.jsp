...
<div class="site-nav">
    <div class="container">
        ...
        <ul class="site-nav-r">
            ...
            <!--购物车信息显示start-->
            <li class="menu dropdown">
                <a href="${pageContext.request.contextPath}/goods/listGoodsCart.action" data-hover="dropdown" data-delay="0" rel="nofollow" target="_blank"><span
            ...
            <div class="box-border member-r">
                ...
                <div class="order_box">
                    <%-- 当没获取到订单编号时，我们提示无处理的订单。当当获取到订单编号，先出处理的订单 --%>
                        <c:choose>
                            <c:when test="${oNum eq null}">
                                <a id="orderInfo" href="${pageContext.request.contextPath}/user/loginPage.action?userName=${sessionScope.userName}">请就此点击进入：您当前无处理的订单，快去主页去选取你喜欢的商品吧！</a>
                            </c:when>
                            <c:otherwise>
                                <div class="order_list">
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                        <tr>
                                            <th>订单编号: <span style="margin-left: 20px">${oNum}</span></th>
                                        </tr>
                                        </thead>
                                    </table>
                                        <%-- 商品明细  --%>
                                    <table class="table table-hover">
                                        ...
                                        <c:forEach items="${goodsList}" var="list" varStatus="loop">
                                            <tr>
                                                <td style="line-height: 50px">${list.goodsName}</td>
                                                <td><img style="width: 50px" src="../../images/goods${list.goodsImg}.jpg" alt="">
                                                </td>
                                                <td style="line-height: 50px">${buyNumsList[loop.count-1].toString()} <b>件</b></td>
                                                <td style="line-height: 50px">${list.goodsPrice}<b>￥</b></td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                        <tr>
                                            <th><span style="margin-left:0px;">总价:<span style="margin-left: 850px">${goodsTotalPrice}  <b>￥</b></span></span></th>
                                        </tr>
                                        <tr>    <!--查看订单利用一个模态框展示-->
                                            <th><span  style="margin-left:0px">     操作:<!-- 按钮触发模态框 -->
                                    <span style="margin-left: 800px">
                                    <a data-toggle="modal" data-target="#myModal">订单详情</a>
                                        <!-- 模态框（Modal） -->
                                    <div class="modal fade" id="myModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title text-center" id="myModalLabel">订单详细信息</h4>
                                                </div>
                                                <div class="modal-body">
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        <c:forEach items="${goodsList}" var="list" varStatus="loop">
                                                            <tr>
                                                                <td style="line-height: 60px">${list.goodsName}</td>
                                                                <td><img style="width: 60px"
                                                                         src="../../images/goods${list.goodsImg}.jpg"
                                                                         alt=""></td>
                                                                <td style="line-height: 60px">${buyNumsList[loop.count-1].toString()} <b>件</b></td>
                                                                <td style="line-height: 60px">${list.goodsPrice} <b>￥</b></td>
                                                            </tr>
                                                        </c:forEach>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        <tr>
                                                            <th>收货人</th>
                                                            <th>${getInfo.getInfoName}</th>
                                                        </tr>
                                                        <tr>
                                                            <th>收货人电话</th>
                                                            <th>${getInfo.getInfoTel}</th>
                                                        </tr>
                                                        <tr>
                                                            <th>配送地址</th>
                                                            <th>${getInfo.getInfoAddress}</th>
                                                        </tr>
                                                        <tr>
                                                            <th>订单状态</th>
                                                            <th>待处理</th>
                                        ...
                                        <!-- 查看订单详情结束 -->
                                    |<a href="${pageContext.request.contextPath}/order/deleteOneDetail.action">删除订单</a> </span> </span></th>
                                        </tr>
                                        </thead>
                                    </table>
                                </div>
                ...
                <ul class="bd">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li id="cancelOrderItem"><a href="${pageContext.request.contextPath}/order/showOrderHistory.action?userName=${sessionScope.userName}">历史订单</a></li>
                            <li id="myEvaluationItem"><a href="">我的评价</a></li>
                            <li id="myAttentionItem"><a href="">我的收藏</a></li>
